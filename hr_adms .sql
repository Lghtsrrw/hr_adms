...
--
-- Table structure for table `address_to`
--
...
--
-- Table structure for table `management_decision`
--

CREATE TABLE `management_decision` (
  `memo_no` varchar(255) NOT NULL,
  `memo_no_base` varchar(255) NOT NULL,
  `base_receive` date NOT NULL,
  `explanation_receive` date NOT NULL,
  `explanation_cited` text NOT NULL,
  `analysis_comment_cited` text NOT NULL,
  `decision_cited` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `user` (`empid`, `username`, `password`, `user_level`) VALUES
('457', 'admin', '123456', 1),
('388', 'user2', '123456', 2),
('32', 'user3', '123456', 3);
...
--
-- Indexes for table `address_to`
--
ALTER TABLE `address_to`
  ADD PRIMARY KEY (`memo_no`,`empid`);
...
--
-- Indexes for table `management_decision`
--
ALTER TABLE `management_decision`
...
ALTER TABLE `memo_status`
  ADD PRIMARY KEY (`memo_no`,`status`);
...
ALTER TABLE `nte_penalty`
  ADD PRIMARY KEY (`penaltyNo`,`memo_no`);
